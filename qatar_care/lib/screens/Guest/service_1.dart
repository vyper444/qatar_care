        ...
        children: [
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                custom.services(ServiceScreenOne(),"images/icons/icon_g_1.png",context),
                custom.services(ServiceScreenTwo(),"images/icons/icon2.png",context),
                custom.services(ServiceScreenOne(),"images/icons/icon3.png",context),
                custom.services(ServiceScreenOne(),"images/icons/icon4.png",context),
              ],
            ),
          ),
          Text(
