            ...
            child: ListTile(
              ...
              trailing: widget.trailing ??
                  RotationTransition(
                    turns: _iconTurns,
                    child: Container(
                        decoration: BoxDecoration(border: Border.all(color:Color(0xFF7EAF3C)),borderRadius:BorderRadius.circular(5)),
                        child: const Icon(Icons.expand_more,color:Color(0xFF7EAF3C),)),
                  ),
            ),
          ),
          ClipRect(
